...
class MyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        for i in 1...3 {
            let student = Student(stuNo: 20160101 + i, firstName: "王", lastName: "\(i)", age: 20, gender: .male, department: .one)
            studentArray.append(student)
        }
        
        for i in 1...5 {
            let teacher = Teacher(title: "教授", firstName: "李", lastName: "\(i)", age: 34, gender: .male, department: .two)
